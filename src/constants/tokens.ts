...
export const WETH9: TokenMap = {
  ...
  [ChainId.SHARDEUM_ALPHANET]: new Token(ChainId.SHARDEUM_ALPHANET, WETH9_ADDRESS[ChainId.SHARDEUM_ALPHANET], 18, 'WETH', 'Wrapped Ether'),
...
export const WNATIVE: TokenMap = {
  ...
  [ChainId.SHARDEUM_ALPHANET]: new Token(ChainId.SHARDEUM_ALPHANET, WNATIVE_ADDRESS[ChainId.SHARDEUM_ALPHANET], 18, 'WSHM', 'Wrapped Shardeum'),
