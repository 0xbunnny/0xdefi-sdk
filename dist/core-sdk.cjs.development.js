...
(function (ChainId) {
  ...
  ChainId[ChainId["SHARDEUM_ALPHANET"] = 8080] = "SHARDEUM_ALPHANET";
...
(function (ChainKey) {
  ...
  ChainKey["KAVA"] = "kava";
  ChainKey["SHARDEUM_ALPHANET"] = "shardeum_alphanet";
...
var Shardeum = /*#__PURE__*/function (_NativeCurrency) {
  _inheritsLoose(Shardeum, _NativeCurrency);

  function Shardeum(chainId) {
    return _NativeCurrency.call(this, chainId, 18, 'SHM', 'Shardeum Coin') || this;
  }

  Shardeum.onChain = function onChain(chainId) {
    var _this$_cache$chainId;

    return (_this$_cache$chainId = this._cache[chainId]) != null ? _this$_cache$chainId : this._cache[chainId] = new Shardeum(chainId);
  };

  var _proto = Shardeum.prototype;

  _proto.equals = function equals(other) {
    return other.isNative && other.chainId === this.chainId;
  };

  _createClass(Shardeum, [{
    key: "wrapped",
    get: function get() {
      var wnative = WNATIVE[this.chainId];
      !!!wnative ?  invariant(false, 'WRAPPED')  : void 0;
...
var Pair = /*#__PURE__*/function () {
  function Pair(currencyAmountA, currencyAmountB) {
    ...
    this.liquidityToken = new Token(currencyAmounts[0].currency.chainId, Pair.getAddress(currencyAmounts[0].currency, currencyAmounts[1].currency), 18, 'Cake-LP', 'Pancake LPs ');
